...
@Configuration
@MapperScan(basePackages = {"com.duduyixia.config.server.dao"}, sqlSessionFactoryRef = "sqlSessionFactoryRDS")
public class MybatisDSConfiguration {
    ...
    private DataSource ds;
        ...
        public SqlSessionTemplate sqlSessionTemplateRDS() throws Exception {
            SqlSessionTemplate template = new SqlSessionTemplate(sqlSessionFactoryRDS());
            return template;
        }
